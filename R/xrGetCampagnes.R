...
xrGetCampagnes <- function(conn, pattern=NULL,
	...
	query <- sprintf ('SELECT %s FROM CAMPMES',
			  paste ('CAMPMES', fields, sep='.', collapse=', ') )
	q <- list()
